...
cp ../Graphics/PCC\ App\ Logo.png ../Graphics/favicon-32.png ../Graphics/apple-touch-icon.png ../Graphics/icon-192.png ../Graphics/icon-512.png ../Graphics/Septa_Bus_EB.svg ../Graphics/Septa_Bus_WB.svg ../Graphics/EB_PCC_App_Logo.svg ../Graphics/WB\ PCC\ App\ Logo.svg www/Graphics/ 2>/dev/null || true
